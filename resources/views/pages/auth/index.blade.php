    ...
    <style>
        ...
        * {
        ...
        .card {
            ...
            margin: auto;
            padding: 20px;
            /* Tambahkan padding untuk memberikan ruang antara elemen-elemen */
        }

        .form-group {
            margin-bottom: 20px;
            /* Tambahkan margin bottom pada form-group */
        }

        .btn {
            margin-top: 10px;
            /* Tambahkan margin top pada tombol */
        }
    </style>
</head>
...
<body>
    ...
    <div class="context">
        <div id="auth" class="d-flex justify-content-center align-items-center vh-100">
            <div class="card">
                <h3 class="auth-title text-black">SISTEM INFORMASI KEUANGAN SATUAN POLISI PAMONG PRAJA KOTA CIREBON.
                </h3>
