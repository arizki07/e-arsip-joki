...
@section('content')
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data PA</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                ...
                <button type="button" class="btn btn-primary ms-auto me-4" data-bs-toggle="modal"
                    data-bs-target="#tambahpa">
                    <i class="bi bi-user"></i> Tambah Data PA
                </button>
    ...
    <div class="modal fade" id="tambahpa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-l">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Pa</h5>
