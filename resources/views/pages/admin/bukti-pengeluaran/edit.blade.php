        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id="pengajuanDetails">
                    <form action="{{ route('bukti-pengeluaran.update', $buktiPengeluaran->id_td_bukti) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                        ...
                        <div class="form-group mt-3" id="uraianContainer">
                            ...
                            <div class="uraian-row">
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        <textarea rows="3" class="form-control mt-1" name="uraian_kegiatan[]" placeholder="Rincian Kode Rekening">{{ old('uraian_kegiatan.0', $buktiPengeluaran->td_uraian) }}</textarea>
                                    </div>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control mt-1" name="uraian_kegiatan_jumlah[]"
                                            placeholder="Jumlah"
                                            value="{{ old('uraian_kegiatan_jumlah.0', $buktiPengeluaran->td_jumlah_biaya) }}">
                                    </div>
                                    <div class="col-md-1">
